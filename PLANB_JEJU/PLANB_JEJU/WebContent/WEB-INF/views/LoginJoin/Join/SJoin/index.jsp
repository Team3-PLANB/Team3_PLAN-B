...
<div id="schedulebox2" style="height:550px; margin:5px;width:150px;">
	<div id="accordion2"> 
		<div class="group"style="height:450px; width:350px; overflow:scroll;">
		<h3 id="a" ondrop="drop(event)" ondragover="allowDrop(event)">DAY 1</h3>
	<div>
			<div class="sortable" > 
		<div>
		 <div class="ui-state-default" style="width:300px;"> <!-- 밥먹고 나서 이거 해보자  -->
		 	<img src="http://img.earthtory.com/img/place_img/312/7505_0_et.jpg"
				alt="" class="spot_img"
				onerror="this.src='/res/img/common/no_img/sight55.png';"
				onclick="window.open('/ko/city/jeju_312/attraction/yongdam-ocean-road_7505');"
				...
				<div class="spot_content_box" style="width:150px;">
					<div class="spot_name"
						onclick="window.open('/ko/city/jeju_312/attraction/yongdam-ocean-road_7505');"
						style="cursor: pointer;">111111</div>
					<div class="spot_info">
						<div class="tag">유명한거리/지역</div>
						<div class="sinfo_line"></div>
						<div class="sinfo_txt" style="padding:0px">
		 ...
		 <div class="ui-state-default" style="width:300px;">
		 	<img src="http://img.earthtory.com/img/place_img/312/7505_0_et.jpg"
				...
				<div class="spot_content_box" style="width:150px;">
					<div class="spot_name"
						onclick="window.open('/ko/city/jeju_312/attraction/yongdam-ocean-road_7505');"
						style="cursor: pointer;">2222222</div>
					<div class="spot_info">
						<div class="tag">유명한거리/지역</div>
						<div class="sinfo_line"></div>
						<div class="sinfo_txt" style="padding:0px">
		 ...
		 <div class="ui-state-default" style="width:300px;">
		 	<img src="http://img.earthtory.com/img/place_img/312/7505_0_et.jpg"
				...
				<div class="spot_content_box" style="width:150px;">
					<div class="spot_name"
						onclick="window.open('/ko/city/jeju_312/attraction/yongdam-ocean-road_7505');"
						style="cursor: pointer;">55555555</div>
					<div class="spot_info">
						<div class="tag">유명한거리/지역</div>
						<div class="sinfo_line"></div>
						<div class="sinfo_txt" style="padding:0px">
	...
	<!-- 5번째 끝 -->
				...
				<h3 id="b" ondrop="drop(event)" ondragover="allowDrop(event)">DAY 2</h3>
				<div>
					<div class="sortable" >
