	...
	<nav class="navbar navbar-default" style="margin:0px;">
		<div class="container">
			<div class="nav-header">
				...
				<h1 id="fh5co-logo">
					<a href="index.jsp"><i class="icon-airplane"></i>PLAN'B JEJU</a>
				</h1>
				...
				<nav id="fh5co-menu-wrap" role="navigation">
					<ul class="sf-menu sf-js-enabled sf-arrows" id="fh5co-primary-menu"
						...
						<security:authorize access="isAnonymous()">
							<li><a
								href="${pageContext.request.contextPath}/LoginJoin/Join/NJoin.do">일정만들기</a>
							</li>
						</security:authorize>
						...
						<li><a
							href="${pageContext.request.contextPath}/PostScript/index.jsp">후기게시판</a></li>
						...
						<security:authorize access="isAnonymous()">
							<li><a
								href="${pageContext.request.contextPath}/LoginJoin/Join/NJoin.do">LOGIN</a>
							</li>
						</security:authorize>
						<!-- 로그아웃 -->
						<security:authorize access="isAuthenticated()">
