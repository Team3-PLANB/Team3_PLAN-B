...
<title>Wedding &mdash; 100% Free Fully Responsive HTML5 Template
					...
					<div class="col-md-8 col-md-offset-2 text-center">
						<div class="display-t">
							<div class="display-tc animate-box" data-animate-effect="fadeIn">
								...
								<h2>낮코밤코</h2>
								<p>
									<a href="#" class="btn btn-default btn-sm">일정 만들기</a>
									<a href="#" class="btn btn-default btn-sm">후기 게시판</a>
									<a href="#" class="btn btn-default btn-sm">로그인/회원가입</a>
								</p>
							</div>
						</div>
					</div>
