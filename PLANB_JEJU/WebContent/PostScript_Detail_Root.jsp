		...
		<div id="fh5co-page">
			...
			<div id="fh5co-tours" class="fh5co-section-gray">
				<div class="container">
					...
					<div class="row row-bottom-padded-md">
						...
						<div id="jssor_1"
							...
							<div data-u="slides"
								...
								<div>
									<img data-u="image" src="images/place-1.jpg" />
									<div data-u="thumb">Do you notice it is draggable by
										mouse/finger?</div>
								</div>
								<div>
									<img data-u="image" src="images/02.jpg" />
									<div data-u="thumb">Did you drag by either horizontal or
										vertical?</div>
								</div>
								<div>
									<img data-u="image" src="images/03.jpg" />
									<div data-u="thumb">Do you notice navigator responses
										when drag?</div>
								</div>
								<div>
									<img data-u="image" src="images/04.jpg" />
									<div data-u="thumb">Do you notice arrow responses when
										click?</div>
								</div>
					...
					<div align="right">
						<a href="PostScript_Board_Root.jsp">목록으로<i
