		...
		<div id="accordion2"
			style="overflow: auto; width: 450px; height: 650px;">
						...
						*/
						...
						var $h3 = $("<h3 ui-accordion-header ui-corner-top ui-state-default ui-accordion-header-active ui-state-active ui-accordion-icons></h3>")
						...
						var $sortable = $("<div class = 'sortable' id='ScheduleDay'></div>");
