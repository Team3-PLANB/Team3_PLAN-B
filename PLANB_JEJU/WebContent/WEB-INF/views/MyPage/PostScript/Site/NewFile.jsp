...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <!-- https://mvnrepository.com/artifact/oreilly/cos -->
<!-- <dependency>
...
***MultipartRequest 객체의 생성자**************************************************
     ...
     ***MultipartRequest 객체의 메서드**************************************************
     ...
     getFile() :  서버에 업로드 된 파일 객체 자체를 반환하는 메소드이다.
      ...
      물리적 경로(웹 서버 특정경로) :
  1. C:\Kosta_151th\Web_JSP\JSPLab\Web_jsp_fileupload_14\WebContent\upload
  2. 이클립스 톰켓 내장 : 
  실제 파일 저장 경로(아래 있는 경로)
  C:\Kosta_151th\Web_JSP\JSPLab\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\Web_jsp_fileupload_14\upload
-->   
<%
   String uploadpath = request.getRealPath("upload");
    out.print(uploadpath + "<br>");
   //파일을 업로드  getRealPath() 함수 사용
  ...
  //기존 사용했던 request 객체
  //실제 저장 서버 경로
  //한번에 업로드 가능한 파일 크기 (10M)
  //파일 중복(btn.jpg > btn1.jpg)
   //여기까지 파일 업로드 완료
   
   //DB 작업 (자료실)
   //작성자 , 제목 , [파일명] , [파일 사이즈] Table 저장하는 후속 작업
   ...
   out.print("hie : " + hid + "<br>");
   out.print("file2 : " + file2 + "<br>");
   out.print("filename2 : " + filename2 + "<br>"); //저장된 이름
   out.print("orifilename2 : " + orifilename2 + "<br>"); //원본 이름
   out.print("<hr>");
...
<body>
   <form action="Ex03_uploadlist.jsp" method="get" name="filelist">
      ...
      <a href="#" onclick="javascript:filelist.submit()">다운로드리스트</a>
   </form>
</body>
</html>