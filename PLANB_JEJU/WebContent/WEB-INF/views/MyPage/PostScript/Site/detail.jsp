<%--
@Project : PLANB_JEJU
@File name : MyPage > PostScript > Site > detail.jsp 
@Author : 임정연 & 정다혜
@Data : 2017.06.16 & 2017.06.22
@Last Edit Data : 2017.07.02
@Desc : 마이페이지 > 나의 후기 > 나의 여행지 후기 상세보기
--%>
					...
					<div class="row row-bottom-padded-md">
						...
						<div id="jssor_1"
							...
							<span data-u="arrowright"
								class="jssora05r" style="top: 0px; right: 8px; width: 40px; height: 40px;" data-autocenter="2"></span>
						</div>
