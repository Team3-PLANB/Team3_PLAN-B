			...
			<div class="col-md-6 col-sm-6 fh5co-tours animate-box fadeInUp animated"
				...
				<div href="#">
					...
					<div class="desc">
						...
						<a class="btn btn-primary btn-outline" href="${pageContext.request.contextPath}/MyPage/PostScript/Route/List.do">
							나의 루트 후기 보기<i class="icon-arrow-right22"></i>
						</a>
					</div>
				</div>
			</div>
			<div class="col-md-6 col-sm-6 fh5co-tours animate-box fadeInUp animated"
				...
				<div href="#">
					<img src="${pageContext.request.contextPath}/images/MyPage/mypostscript2.jpg"
						alt="MySitePostScript" class="img-responsive">
					<div class="desc">
						<span class="price">나의 여행지 후기</span> 
						<a class="btn btn-primary btn-outline" href="${pageContext.request.contextPath}/MyPage/PostScript/Site/List.do">
							나의 여행지 후기 보기<i class="icon-arrow-right22"></i>
						</a>
					</div>
				</div>
			</div>
