<%--
@Project : PLANB_JEJU
@File name :  MyPage > PostScript > Route > listBoard.jsp 
@Author : 임정연 & 정다혜
@Data : 2017.06.16 & 2017.06.23
@Last Edit Data : 2017.06.23
@Desc : 마이페이지 > 나의 후기 > 나의 루트 후기 리스트
--%>
	...
	<div id="fh5co-wrapper">
		<div id="fh5co-page">
			<div id="fh5co-tours" class="fh5co-section-gray">
				...
				<%------------------------------나의 루트 후기 게시판의 header ----------------------------------------%>
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
							<h3>나의 루트 후기 게시판</h3>
							<ul class="portfolio-filter" style='align:center'>
								<li>
									<a class="btn btn-default default active" href="${pageContext.request.contextPath}/MyPage/PostScript/Route/List.do" data-filter=".a">
										나의 루트 후기
									</a>
								</li>
								<li>
									<a class="btn btn-default" href="${pageContext.request.contextPath}/MyPage/PostScript/Site/List.do" data-filter=".b">
										나의 여행지 후기
									</a>
								</li>
							</ul>
					...
					<%-----------------------------검색 부분 ----------------------------------------%>
					<form action="${pageContext.request.contextPath}/MyPage/PostScript/Route/List.do">
								...
								<div class="col-lg-4 col-md-4 col-sm-6">
									<div class="fh5co-blog animate-box">
										<a href="${pageContext.request.contextPath}/MyPage/PostScript/Route/Detail.do?route_postscript_rownum=${routePostscript.route_postscript_rownum}">
											<img class="img-responsive" src="${pageContext.request.contextPath}/images/travel/${routePostscript.route_thumbnail}" alt="">
										</a>
