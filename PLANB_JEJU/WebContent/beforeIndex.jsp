...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<a href="${pageContext.request.contextPath}/LoginJoin/Join/NJoin.do">회원가입&로그인_단비</a><br>
		<a href="${pageContext.request.contextPath}/LoginJoin/Join/NJoin2.do">회원가입&로그인_다혜</a><br>
