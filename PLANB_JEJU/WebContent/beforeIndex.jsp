...
<!-- 으악 -->
	...
	<body>
		...
		<a href="${pageContext.request.contextPath}/LoginJoin/Join/NJoin.do">회원가입_단비</a><br>
		<a href="${pageContext.request.contextPath}/LoginJoin/Login/NLogin.do">로그인_단비</a><br>
