...
public class RouteHistory {
	...
	public RouteHistory(int route_code, String username, int route_order, Date route_date, int update_rownum,
			String update_reason, String site, String lon, String lat, String category, Time stime, Time etime) {
		super();
	...
	public String toString() {
		return "route_detail [route_code=" + route_code + ", username=" + username + ", route_order=" + route_order
				+ ", route_date=" + route_date + ", update_rownum=" + update_rownum + ", update_reason=" + update_reason
				+ ", site=" + site + ", lon=" + lon + ", lat=" + lat + ", category=" + category + ", stime=" + stime
				+ ", etime=" + etime + "]";
	}
